package com.yao.mvppattern.tool;
...
public class StateTool {
    ...
    private static  int emptyImageResId = R.drawable.empty;
    //错误页面图片,默认用的安卓sdk里面的图片,严重建议替换成一个256px左右的图片 默认使用android.R.drawable.ic_menu_search
    private static  int errorImageResId = R.drawable.error;
